...
// pBit abstraction layer (probabilistic bit computing)
pub mod pbit_state;
pub mod pbit_gates;
pub mod pbit_backend;
pub mod pbit_lattice_bridge;
...
// pBit re-exports
pub use pbit_state::{PBit, PBitConfig, PBitCoupling, PBitState, ToPBitState, FromPBitState};
pub use pbit_gates::{
    PBitGate, PBitCircuit,
    HadamardGate, PauliXGate, PauliYGate, PauliZGate,
    RXGate, RYGate, RZGate, SGate, TGate,
    CNOTGate, CZGate, SWAPGate, ISWAPGate,
    ToffoliGate, FredkinGate,
};
pub use pbit_backend::{
    PBitBackend, PBitBackendConfig, PBitBackendFactory, PBitBackendPool,
    PBitExecutionResult, PBitExecutable, BackendStats,
};
pub use pbit_lattice_bridge::{
    LatticeState, LatticeBridgeConfig, LatticeNode as LatticeBridgeNode,
    LatticeCoupling, LatticeCompatible,
};
