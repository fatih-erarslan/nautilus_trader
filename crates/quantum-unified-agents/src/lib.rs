...
pub mod pbit_lattice_coordination;
...
pub use pbit_lattice_coordination::{
    PBitLatticeCoordinator, PBitCoordinationConfig, AgentNode, AgentCoupling,
    CoordinationSignal, CoordinationSignalType, CoordinationAction,
    SharedPBitCoordinator, create_shared_coordinator,
};
