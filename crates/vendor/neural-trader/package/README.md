...
### Agentic Accounting System - CI/CD Status
...
[![Coverage](https://img.shields.io/codecov/c/github/ruvnet/neural-trader?flag=agentic-accounting&label=coverage)](https://codecov.io/gh/ruvnet/neural-trader)
...
**26 Modular Packages** • **8-19x Faster** • **112+ MCP Tools** • **Zero-Overhead NAPI** • **Production-Ready**
...
- **112+ MCP Tools** - Native Claude Desktop integration (incl. 10+ accounting tools)
...
Neural Trader uses a **plugin-style architecture** with 26 independent packages (19 production + 7 in-development). Think of it like LEGO blocks—start with what you need, add more as you grow.
...
```
> 📦 **Total:** ~2.3 MB | **What you can do:** Use LSTM/Transformer models for predictions with guaranteed confidence intervals
...
```
> 📦 **Total:** ~200 KB | **What you can do:** Control trading from Claude Desktop (112+ tools including accounting)
...
| [`@neural-trader/predictor`](https://www.npmjs.com/package/@neural-trader/predictor) | ~400 KB | **Conformal prediction** ✨ - Mathematically guaranteed prediction intervals with 90%+ coverage, adaptive inference, WASM acceleration |
...
### E2B Sandbox Strategies ✨ NEW
| Package | Size | Description |
|---------|------|-------------|
| [`@neural-trader/e2b-strategies`](https://www.npmjs.com/package/@neural-trader/e2b-strategies) | ~36 KB | **Multi-agent swarm coordination** 🐝 - 23x faster coordination with agentic-jujutsu, self-learning AI via ReasoningBank, E2B sandbox isolation, quantum-resistant security, comprehensive benchmarking. Deploy strategies in isolated E2B sandboxes with zero-conflict coordination, automatic learning from every execution, and 87% auto-conflict resolution. Includes swarm deployment CLI, performance benchmarking framework, and AI-powered optimization recommendations. |

### Agentic Accounting System 🧮 IN DEVELOPMENT
| Package | Status | Description |
|---------|--------|-------------|
| `@neural-trader/agentic-accounting-types` | 🔧 Dev | **Shared TypeScript types** - Type definitions for transactions, tax lots, disposals, positions, compliance rules, and audit entries |
| `@neural-trader/agentic-accounting-rust-core` | 🔧 Dev | **High-performance Rust addon** - Sub-10ms tax calculations with FIFO, LIFO, HIFO, Specific ID, Average Cost methods. Includes wash sale detection and precise decimal arithmetic via rust_decimal |
| `@neural-trader/agentic-accounting-core` | 🔧 Dev | **Core TypeScript library** - Transaction ingestion, compliance validation, fraud detection, tax-loss harvesting, IRS form generation (Schedule D, Form 8949), PostgreSQL/AgentDB integration |
| `@neural-trader/agentic-accounting-agents` | 🔧 Dev | **Multi-agent swarm** - 8 specialized agents: TaxComputeAgent, IngestionAgent, ComplianceAgent, ForensicAgent, ReportingAgent, HarvestingAgent, LearningAgent, CoordinatorAgent. ReasoningBank integration for persistent learning |
| `@neural-trader/agentic-accounting-mcp` | 🔧 Dev | **MCP server** - 10+ accounting tools for Claude Code integration: tax calculation, compliance checks, fraud detection, position tracking, report generation |
| `@neural-trader/agentic-accounting-api` | 🔧 Dev | **REST & GraphQL APIs** - Full-featured APIs with JWT authentication, rate limiting, Express + Apollo Server, comprehensive OpenAPI documentation |
| `@neural-trader/agentic-accounting-cli` | 🔧 Dev | **Command-line interface** - Interactive CLI with 10+ commands for tax calculations, compliance checks, fraud detection, report generation, agent management |

> **📝 Note:** Agentic Accounting packages are currently in active development. See [complete SPARC specification](./plans/agentic-accounting/) for architecture details, implementation roadmap, and progress tracking.
>
> **Key Features (When Complete):**
> - ✨ **5 Tax Methods**: FIFO, LIFO, HIFO, Specific ID, Average Cost
> - ✨ **50-100x Performance**: Rust-powered calculations (<10ms per transaction)
> - ✨ **Vector-Based Fraud Detection**: <100µs queries with AgentDB HNSW indexing
> - ✨ **Wash Sale Compliance**: Automatic 30-day IRS window detection
> - ✨ **IRS Form Generation**: Schedule D, Form 8949 (all 6 categories)
> - ✨ **Tax-Loss Harvesting**: Automated opportunity identification
> - ✨ **Merkle Audit Trails**: Cryptographically tamper-evident with Ed25519 signatures
> - ✨ **Self-Learning Agents**: ReasoningBank integration for continuous improvement
> - ✨ **Formal Verification**: Lean4 theorem proving for accounting invariants
>
...
> - 🔧 **In Progress**: Fixing TypeScript build errors, preparing for npm publication
>
> **Documentation:**
> - [SPARC Specification](./plans/agentic-accounting/) - Complete system specification
> - [Phase 1 Report](./plans/agentic-accounting/completion/PHASE-1-COMPLETE.md) - Foundation infrastructure details
> - [Final Report](./docs/agentic-accounting/FINAL-REPORT.md) - Comprehensive implementation report
...
# Deploy strategies to E2B sandboxes with swarm coordination
npm run swarm:deploy -- -s momentum -a 5

# Run comprehensive performance benchmarks
npm run swarm:benchmark

# View learning statistics and discovered patterns
...
console.log(`Discovered ${patterns.length} successful patterns`);
```

**Key Features:**
- 🐝 **23x Faster Coordination**: 350 ops/sec vs 15 ops/sec traditional
- 🧠 **Self-Learning AI**: Learns from every execution via ReasoningBank
- 🔒 **Quantum-Resistant**: SHA3-512 + HQC-128 encryption
- 📊 **Comprehensive Benchmarking**: P95/P99 latency, throughput analysis
- 🎯 **87% Auto-Conflict Resolution**: Zero-lock coordination
- ⚡ **<2s Sandbox Startup**: Fast E2B sandbox initialization

**Learn More:** [E2B Strategies Documentation](https://www.npmjs.com/package/@neural-trader/e2b-strategies)
...
**16 production-ready examples** demonstrating neural-trader across diverse domains:

### 🏦 Financial Trading (4 Examples)
- **Market Microstructure Analysis** - Real-time order flow with VPIN, liquidity scoring (<1ms)
- **Portfolio Optimization** - Mean-Variance, Risk Parity, Black-Litterman with swarm benchmarking
- **Multi-Strategy Backtesting** - Momentum, mean reversion, arbitrage with realistic costs
- **Quantum Optimization** - QAOA, VQE, quantum annealing for portfolio selection

### 🏥 Healthcare & Operations (3 Examples)
- **Healthcare Optimization** - Patient flow, queue optimization, staff scheduling (<50ms)
- **Logistics Optimization** - Vehicle routing (CVRP) with time windows (<200ms for 100 locations)
- **Supply Chain Prediction** - Demand forecasting with inventory optimization

### ⚡ Energy & Utilities (2 Examples)
- **Energy Grid Optimization** - Load forecasting, unit commitment, battery storage (<100ms)
- **Energy Forecasting** - Solar/wind prediction with weather integration

### 🤖 Advanced AI Techniques (5 Examples)
- **Anomaly Detection** - Isolation Forest, autoencoders, conformal prediction (<10ms, 90%+ accuracy)
- **Dynamic Pricing** - RL-based pricing with demand elasticity modeling
- **Evolutionary Game Theory** - ESS calculation, replicator dynamics, tournaments
- **Adaptive Systems** - Boids, ant colony, cellular automata, ecosystem modeling
- **Neuromorphic Computing** - Spiking neural networks for ultra-low-latency applications

### 🧪 Testing & Benchmarking (2 Examples)
- **Benchmarks** - Comprehensive performance benchmarking framework
- **Test Framework** - Testing utilities and patterns

### 🚀 Quick Start with Examples

```bash
# Install complete platform (includes all examples)
npm install neural-trader
...
npx neural-trader examples --run portfolio-optimization
```

### 🔗 Cross-Domain Integration

Mix and match examples across domains:
- **Finance + Healthcare**: Medical investment portfolio optimization
- **Energy + Logistics**: EV fleet management with demand forecasting
- **Supply Chain + Anomaly Detection**: Disruption prevention and monitoring
- **Trading + Game Theory**: Competitive market strategy analysis
...
- ✅ **OpenRouter Integration** for AI-powered insights
- ✅ **Production-Ready** with comprehensive tests (>80% coverage)
...
Neural Trader includes 14+ production-ready example packages demonstrating cutting-edge applications of neural prediction, self-learning optimization, and swarm intelligence across diverse domains. Each example features AgentDB memory persistence, OpenRouter AI integration, and comprehensive benchmarks.

### Production-Ready Examples

| Package | npm Link | Description | Key Features |
|---------|----------|-------------|--------------|
| **Portfolio Optimization** | [@neural-trader/example-portfolio-optimization](https://www.npmjs.com/package/@neural-trader/example-portfolio-optimization) | Self-learning portfolio optimization with 4 algorithms (Mean-Variance, Risk Parity, Black-Litterman, Multi-Objective) | Efficient frontier, adaptive risk, swarm constraints |
| **Multi-Strategy Backtest** | [@neural-trader/example-multi-strategy-backtest](https://www.npmjs.com/package/@neural-trader/example-multi-strategy-backtest) | Reinforcement learning strategy allocation across momentum, mean-reversion, pairs trading, market making | Walk-forward optimization, regime detection, RL allocation |
| **Market Microstructure** | [@neural-trader/example-market-microstructure](https://www.npmjs.com/package/@neural-trader/example-market-microstructure) | Real-time order flow analysis with self-learning pattern recognition | Spread/depth/toxicity metrics, swarm feature engineering |
| **Energy Forecasting** | [@neural-trader/example-energy-forecasting](https://www.npmjs.com/package/@neural-trader/example-energy-forecasting) | Multi-horizon forecasting for solar, wind, demand with conformal prediction | ARIMA/LSTM/Transformer/Prophet ensemble, uncertainty quantification |
| **Supply Chain Prediction** | [@neural-trader/example-supply-chain-prediction](https://www.npmjs.com/package/@neural-trader/example-supply-chain-prediction) | Demand forecasting and inventory optimization with uncertainty | Multi-echelon optimization, (s,S) policies, swarm exploration |
| **Anomaly Detection** | [@neural-trader/example-anomaly-detection](https://www.npmjs.com/package/@neural-trader/example-anomaly-detection) | Adaptive threshold anomaly detection for fraud, security, trading | Isolation Forest, LSTM-AE, VAE, One-Class SVM ensemble |
| **Logistics Optimization** | [@neural-trader/example-logistics-optimization](https://www.npmjs.com/package/@neural-trader/example-logistics-optimization) | Multi-agent vehicle routing with swarm coordination | VRP with time windows, 12+ agent swarms, self-learning traffic patterns |
| **Dynamic Pricing** | [@neural-trader/example-dynamic-pricing](https://www.npmjs.com/package/@neural-trader/example-dynamic-pricing) | RL-based dynamic pricing for e-commerce, hotels, airlines | Q-Learning, DQN, PPO, price elasticity learning, competitive analysis |
| **Energy Grid Optimization** | [@neural-trader/example-energy-grid-optimization](https://www.npmjs.com/package/@neural-trader/example-energy-grid-optimization) | Unit commitment and load forecasting for power grids | Multi-horizon forecasting, renewable integration, battery optimization |
| **Healthcare Optimization** | [@neural-trader/example-healthcare-optimization](https://www.npmjs.com/package/@neural-trader/example-healthcare-optimization) | Patient flow and staff scheduling optimization | Queue theory, arrival forecasting, swarm scheduling, privacy-preserving |
| **Quantum Optimization** | [@neural-trader/example-quantum-optimization](https://www.npmjs.com/package/@neural-trader/example-quantum-optimization) | Quantum-inspired algorithms (QAOA, VQE, Quantum Annealing) | MaxCut, TSP, portfolio, constraint satisfaction problems |
| **Adaptive Systems** | [@neural-trader/example-adaptive-systems](https://www.npmjs.com/package/@neural-trader/example-adaptive-systems) | Self-organizing multi-agent systems (Boids, ACO, Cellular Automata) | Emergence detection, swarm intelligence, pattern formation |
| **Neuromorphic Computing** | [@neural-trader/example-neuromorphic-computing](https://www.npmjs.com/package/@neural-trader/example-neuromorphic-computing) | Spiking Neural Networks with STDP learning | LIF neurons, reservoir computing, ultra-low-power ML |
| **Evolutionary Game Theory** | [@neural-trader/example-evolutionary-game-theory](https://www.npmjs.com/package/@neural-trader/example-evolutionary-game-theory) | Strategy evolution with replicator dynamics and ESS | 100+ strategy tournaments, genetic algorithms, coevolution |
...
# Install all examples (recommended for exploration)
npm install @neural-trader/example-portfolio-optimization \
...
npx @neural-trader/example-portfolio-optimization
npx @neural-trader/example-multi-strategy-backtest
```

### Shared Frameworks

All examples are built on production-tested frameworks:

**OpenRouter Integration**
- Universal LLM access (50+ models: GPT-4, Claude, Llama, Mistral)
- Automatic fallback and load balancing
- Cost optimization and usage tracking
- Streaming responses for real-time analysis

**Benchmark Swarm Framework**
- Comprehensive performance testing with statistical validation
- Parallel execution across multiple scenarios
- Automated performance regression detection
- Real-time metrics visualization and reporting

**Self-Learning Framework**
- AgentDB-powered persistent memory (150x faster vector search)
- ReasoningBank adaptive learning (trajectory tracking, verdict judgment)
- Pattern discovery and strategy optimization
- Cross-session knowledge retention and improvement

### Example Usage

```typescript
// Portfolio Optimization with Self-Learning
import { PortfolioOptimizer } from '@neural-trader/example-portfolio-optimization';
...
```typescript
// Multi-Strategy Backtest with RL Allocation
import { MultiStrategyBacktest } from '@neural-trader/example-multi-strategy-backtest';

const backtest = new MultiStrategyBacktest({
  strategies: ['momentum', 'mean-reversion', 'pairs-trading'],
  allocationMethod: 'reinforcement-learning',
...
console.log('Strategy Allocation:', results.allocation);
...
- [Complete Documentation](packages/examples/README.md) - In-depth guides for all examples
- [Integration Guide](packages/examples/docs/INTEGRATION_GUIDE.md) - How to integrate examples into your projects
- [Best Practices](packages/examples/docs/BEST_PRACTICES.md) - Production deployment guidelines
- [Performance Benchmarks](packages/examples/docs/BENCHMARKS.md) - Comprehensive performance analysis
- [API Reference](packages/examples/docs/API.md) - Detailed API documentation
