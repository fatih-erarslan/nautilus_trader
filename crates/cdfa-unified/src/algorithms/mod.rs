//! # CDFA Algorithms Module
//!
//! Advanced signal processing and analysis algorithms for CDFA
//! This module consolidates functionality from cdfa-algorithms crate
//!
//! ## Features
//!
//! - **Wavelet Analysis**: Complete discrete and continuous wavelet transforms
//! - **Entropy Measures**: Sample, permutation, Shannon, and approximate entropy
//! - **Volatility Analysis**: Clustering, regime detection, and modeling
//! - **Signal Processing**: Detrending, filtering, and noise reduction
//! - **Statistical Measures**: Advanced quantile estimation and distribution fitting
//! - **Calibration**: Time series alignment and calibration methods
...
// Re-exports for compatibility and convenience
...
mod tests {
    ...
    fn test_integration() {
        ...
        // Wavelet
        let (approx, _detail) = WaveletTransform::dwt_haar(&signal.view()).unwrap();
