...
// Supporting modules (were missing exports)
pub mod types;
pub mod stubs;
pub mod tail_risk;
pub mod safe_math;
...
// pBit Monte Carlo (Wolfram validated)
pub mod pbit_monte_carlo;
pub use pbit_monte_carlo::{
    PBitTailRiskEngine, TailRiskAnalysis,
    KellyCriterion, BlackSwanDetector, BarbellStrategy, AntifragilityMeasure,
};
