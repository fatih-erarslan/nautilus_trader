...
try:
    ...
    warnings.warn("PyTorch not available. Model optimization will be limited.", DeprecationWarning, DeprecationWarning)
...
try:
    ...
    warnings.warn("Numba not available. Acceleration will be limited.", DeprecationWarning, DeprecationWarning)
...
try:
    ...
    warnings.warn("Norse not available. Neuromorphic computing will be limited.", DeprecationWarning, DeprecationWarning)
...
try:
    ...
    warnings.warn("Rockpool not available. Neuromorphic computing will be limited.", DeprecationWarning, DeprecationWarning)
