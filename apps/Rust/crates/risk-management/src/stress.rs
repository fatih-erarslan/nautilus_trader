...
use crate::types::{Portfolio, Position, StressScenario};
...
impl StressTester {
    ...
    async fn calculate_quantum_tail_enhancement(
        ...
        Ok(QuantumTailRisk {
            quantum_enhancement: uncertainty_quantification.quantum_advantage,
            tail_dependency_correction: uncertainty_quantification.correlations.uncertainty_level,
            tail_coherence: uncertainty_quantification.conformal_intervals.tail_risk_quantum,
        })
    }
    ...
    async fn portfolio_to_quantum_data(
        &self,
        portfolio: &Portfolio,
    ) -> RiskResult<crate::quantum::QuantumPortfolioData> {
