...
impl PerformanceTracker {
    ...
    pub async fn record_performance(&self, metrics: SwarmPerformanceMetrics) -> Result<(), SwarmSelectionError> {
    ...
    pub async fn cleanup_old_data(&self, cutoff_time: DateTime<Utc>) -> Result<(), SwarmSelectionError> {
        let mut history = self.metrics_history.write().await;
