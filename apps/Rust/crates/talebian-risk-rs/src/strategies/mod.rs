...
// Re-export key types
pub use barbell::*;
// pub use convexity::*;  // Unused
// pub use ensemble::*;   // Unused
// pub use hormesis::*;   // Unused
// pub use lindy::*;      // Unused
// pub use option_strategy::*;  // Unused
// pub use skin_in_game::*;     // Unused
// pub use via_negativa::*;     // Unused
...
pub mod utils {
    ...
    pub fn risk_adjusted_position_sizes(
        ...
        volatilities: &HashMap<String, f64>,
        _correlations: &HashMap<(String, String), f64>,
        risk_aversion: f64,
    ) -> Result<HashMap<String, f64>> {
...
mod tests {
    ...
    fn test_portfolio_volatility() {
        ...
        let portfolio_vol =
            calculate_portfolio_volatility(&weights, &volatilities, &correlations).unwrap();
