...
impl MetricsCalculator {
    ...
    pub fn calculate_risk_adjusted_metrics(&self, returns: &[f64]) -> Result<RiskAdjustedMetrics> {
        ...
        {
            let benchmark_mean =
                self.benchmark_returns.iter().sum::<f64>() / self.benchmark_returns.len() as f64;
            ...
            let benchmark_variance = self
                ...
                .sum::<f64>()
                / (self.benchmark_returns.len() - 1) as f64;
            ...
            let alpha =
                mean_return - (self.risk_free_rate + beta * (benchmark_mean - self.risk_free_rate));
    ...
    pub fn calculate_drawdown_analysis(&self, returns: &[f64]) -> Result<DrawdownAnalysis> {
        ...
        Ok(DrawdownAnalysis {
            ...
            recovery_time: if drawdown_count > 0 {
                recovery_time / drawdown_count
            } else {
                0
            },
            drawdown_frequency,
    ...
    pub fn calculate_tail_risk_metrics(&self, returns: &[f64]) -> Result<TailRiskMetrics> {
        ...
        let bottom_10_avg =
            sorted_returns[0..bottom_10_idx].iter().sum::<f64>() / bottom_10_idx as f64;
...
mod tests {
    ...
    fn test_metrics_calculator() {
        ...
        let risk_metrics = calculator
            .calculate_risk_adjusted_metrics(&returns)
            .unwrap();
    ...
    fn test_with_benchmark() {
        ...
        let metrics = calculator
            .calculate_risk_adjusted_metrics(&portfolio_returns)
            .unwrap();
    ...
    fn test_attribution() {
        ...
        let attribution = calculator
            .calculate_attribution(&portfolio_returns, &asset_returns, &weights)
            .unwrap();
